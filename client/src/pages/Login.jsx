...
// import { apiService } from '../services/api'  // ✅ matches your api.js export
...
//         setIsAuthenticated(true)
//         toast.success('Welcome to FlawFinder AI! (Demo Mode)')
//         navigate('/dashboard')
//       } else {
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-400 text-sm">
                  ...
                  <Link
                    ...
                    className="text-purple-400 hover:text-purple-300 transition-colors font-medium cursor-pointer relative z-20"
                  >
                    Create one here
                  </Link>
                </p>
